...
def SpectrometerMoveThread(controller, *args, **kwargs):
    ...
    if controller.__class__.__module__.endswith("spectrometer_princeton"):
        from src.hardware.spectrometer_princeton import SpectrometerMoveThread as ThreadClass
    elif controller.__class__.__module__.endswith("spectrometer_oceanoptics"):
        from src.hardware.spectrometer_oceanoptics import SpectrometerMoveThread as ThreadClass
    else:
        from src.hardware.spectrometer_andor import SpectrometerMoveThread as ThreadClass
